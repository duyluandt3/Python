...
cascade_face = cv2.CascadeClassifier(r'./data/haarcascades/haarcascade_frontalface_default.xml')
cascade_eye = cv2.CascadeClassifier(r'./data/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
cascade_smile = cv2.CascadeClassifier(r'./data/haarcascades/haarcascade_smile.xml')
